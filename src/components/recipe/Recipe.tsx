        ...
        {showAllContent && (
          <div>
            ...
            {recipe.ingredients.map((ingredient) => (
              <div className="content_ingredient" key={ingredient.id}>
                <p>{ingredient.name}</p>
                <span className="card__text">
                  {ingredient.quantity * personNumber} {ingredient.unitMeasure}
                </span>
              </div>
            ))}

            <p className="card__text">{recipe.difficulty}</p>
            <p className="card__text">{recipe.preparationTime} min</p>
            <p className="card__text" style={{ textTransform: 'capitalize' }}>
              {recipe.tag}
            </p>
          </div>
        )}
